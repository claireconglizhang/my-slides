...
Putting the models and plots together, for your curiosity, 
 ...
 - the change in slope is $\beta_2$
 - the change in slope is $\beta_3$, representing the change in the Y-X relationship that is correlated with one unit change in Z (from Z=0 to Z=1)
...
Compared to pre-pandemic, the average score was 4.450 lower (p < 0.001) post pandemic.
...
In schools where no student receives free/reduced lunch (frpl = 0 or 0%), 
 ...
 - intercept: 92.548, is the pre-pandemic average score
 - slope: −4.531, is the change in score after pandemic, compared to pre-pandemic

Careful - in schools where all students receives free/reduced lunch (frpl = 1 or 100%) (hint: plug frpl = 1 into your model), 

 - intercept: 92.548 - 37.201 = 55.347, is the pre-pandemic average score
 - slope: -4.531 + 0.173 = -4.358, is the change in score after pandemic, compared to pre-pandemic
...
The change in slope is (-4.358) - (-4.531) = 0.173. It is identical to the value of $\beta_3$. Based on an alpha threshold of 0.05, it is not statistically significant. The differences in students' ORF trajectories pre- and post-pandemic-onset did not change by the proportion of students receiving free- or reduced-price lunch (FRPL) in their schools.
...
For grade 1 students, 
 ...
 - intercept: 29.249, is the pre-pandemic average score
 - slope: -3.686, is the change in score after pandemic, compared to pre-pandemic

Careful - for grade 2 students (hint: plug these into your model, grade2 = 1, grade3 = 0, grade4 = 0, grade5 = 0. [How to? CHECK THE LECTURE](https://daviddliebowitz.github.io/EDUC643_23W/slides/EDUC643_13_interactions.html#30)), 

 - intercept: 29.249 + 40.186 = 69.435, is the pre-pandemic average score
 - slope: (-3.686) + (-2.398) = -6.084, is the change in score after pandemic, compared to pre-pandemic

Careful - for grade 3 students, 

 - intercept: 29.249 + 60.484 = 89.733, is the pre-pandemic average score
 - slope: (-3.686) + (-0.094) = -3.78, is the change in score after pandemic, compared to pre-pandemic

Careful - for grade 4 students, 

 - intercept: 29.249 + 82.668 = 111.917, is the pre-pandemic average score
 - slope: (-3.686) + (-0.988) = -4.674, is the change in score after pandemic, compared to pre-pandemic

Careful - for grade 5 students, 

 - intercept: 29.249 + 82.919 = 112.168, is the pre-pandemic average score
 - slope: (-3.686) + 0.083 = -3.603, is the change in score after pandemic, compared to pre-pandemic
...
The difference in slope between grade 1 and 2 was the coefficient on post1 × grade2, which was −2.398. It means that, compared to grade 1 students, the difference in students' ORF trajectories pre- and post-pandemic-onset was 2.398 smaller for grade 2 students. It was statistically significant. It is one of the answers to Q3. 

To answer Q3 further, we just need to look at the coefficients of "post1 × grade3", "post1 × grade4", and "post1 × grade5", and we notice that for grades 3-5, the difference in students' ORF trajectories pre- and post-pandemic-onset did not significantly differ compared to grade 1.
...
In schools where no student receives free/reduced lunch (frpl = 0 or 0%), 
 ...
 - intercept: 81.126, is the average score for schools with no enrollment
 - slope: -39.378, is the change in score related to one student enrollment at school 

Careful - in schools where all students receives free/reduced lunch (frpl = 1 or 100%), 

 - intercept: 81.126 + 0.025 = 81.151, is the average score for schools with no enrollment
 - slope: (-39.378) + 0.013 = -39.365, is the change in score related to one student enrollment at school
...
The difference in slope from schools where no student receives free/reduced lunch to schools where all students receives free/reduced lunch was 0.013. It was statistically significant. It means that, on average, one student enrollment at school is correlated with 0.013 (p < 0.01) increase in the relationship between students' average ORF scores and the rate of FRPL-receipt - 100% increase in the rate of FRPL-receipt is related to 39.378 (p < 0.001) decrease in score. 
