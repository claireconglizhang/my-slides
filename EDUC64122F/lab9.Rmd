...
### Goal 1. datasummary_skim(): quick overview of numeric or categorical variables
  ...
  - But directly using datasummary_skim() didn't work well, why? (see next slide for result)
...
#### Because datasummary_skim() summarizes continuous and categorical variables differently (as it should) AND it doesn't allow users to summarize two types together in a single table
  - So first thing first, select the variables you'll be using, check their types, and recode them as needed
  - Today we'll be using three variables: **status**, **total_expenditure**, and **life_expectancy**
     - Note that the variable **status** didn't show up in the previous slide, because of the default argument: datasummary_skim(type = "continuous") 
  
<img src="lab903.png" style="width: 80%" />

---
You don't need these code for assignment 4 but for your curiosity 
...
---
You don't need these code for assignment 4 but for your curiosity as a researcher
<img src="lab907.png">
