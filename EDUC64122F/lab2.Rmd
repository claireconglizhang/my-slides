...
3. Start your workflow and prepare for assignments
  ...
  - Here you have tons of questions: what is .Rmd or .R file? what do you mean by "render"? how do you produce tables and figures in R?...
      - while we'll save most of this to future weeks but today you'll learn the first two steps
...
2. Add a couple of folders to your project root folder (do it with me; each in a different way)
  - data
  - literature
3. Add a dataset to your "data" folder
  - Go to my slides page (https://claireconglizhang.github.io/my-slides/) and download the "ah_smoke.csv" dataset and codebook (also I'll show you in next slide) 
...
1. Within the project, create an R script: a file with the .R extension (do it with me), and save it to your project root folder
2. Run the following two code lines and see what happened
  - df <- rio::import(here::here("data", "ah_smoke.csv"))
  - df
3. Talk with you neighbor (push this to next week for Monday lab folks):
  - How many rows and columns in this dataset? Rstudio give "rows" and "columns" "new" names, what are they?
  - Ignore the all-numeric-coding of the data, refer to the codebook, find four measures on
     - Nominal scale
     - Ordinal scale
     - Interval scale
     - Ratio scale
